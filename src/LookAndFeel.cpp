...
BerryLookAndFeel::BerryLookAndFeel(bool controlled) : controlled(controlled) {
...
void BerryLookAndFeel::drawRotarySlider(juce::Graphics& g,
                                        int x,
                                        int y,
                                        int width,
                                        int height,
...
void BerryLookAndFeel::drawComboBox(juce::Graphics& g,
                                    int width,
                                    int height,
                                    bool isButtonDown,
                                    int buttonX,
...
void BerryLookAndFeel::positionComboBoxText(juce::ComboBox& box, juce::Label& label) {
    label.setBounds(1, 1, box.getWidth() - ARROW_ZONE_WIDTH, box.getHeight() - 2);
    label.setFont(getComboBoxFont(box));
}
void BerryLookAndFeel::drawLabel(juce::Graphics& g, juce::Label& label) {
...
void BerryLookAndFeel::drawPopupMenuBackground(juce::Graphics& g, int width, int height) {
...
void BerryLookAndFeel::drawPopupMenuItem(juce::Graphics& g,
...
juce::Path BerryLookAndFeel::getTickShape(float height) {
    auto w = height / 4;
    auto h = height / 4;
    auto x = height / 2 - w / 2;
    auto y = height / 2 - h / 2;
...
void BerryLookAndFeel::drawButtonBackground(Graphics& g,
                                            Button& button,
